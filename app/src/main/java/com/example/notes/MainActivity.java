...
public class MainActivity extends AppCompatActivity {
    ...
    public void onLoad() {
        ...
        for(int i = 0; i<list_nites.size(); i++){
            ...
            LinearLayout il_ver = new LinearLayout(this);
            il_ver.setOrientation(LinearLayout.VERTICAL);
            il_ver.setLayoutParams(params);
            ...
            li.addView(iv);
            li.addView(il_ver);
            il_ver.addView(tv_name);
            il_ver.addView(tv_data);
